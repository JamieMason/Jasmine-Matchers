describe('Dates', function() {
  ...
  describe('toBeDate', function() {
    it('should assert value is an instance of Date', function() {
  ...
  describe('toBeIso8601', function() {
    it('should assert value is a Date String conforming to the ISO 8601 standard', function() {
      // format
  ...
  describe('toBeBefore', function() {
    it('should assert value is a Date occurring before another Date', function() {
  ...
  describe('toBeAfter', function() {
    it('should assert value is a Date occurring after another Date', function() {
